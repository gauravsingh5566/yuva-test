...
export const PrivateClubComponents = ({
    ...
    allClubStudent,getAllInstituteClub}) => {
        ...
        return (
          <div>
            {
              privateClub?.length !== 0 &&
              <Card className='col-10' style={{borderRadius: "18px"}}>
      <Card.Body>
      <div className='mb-1 d-flex justify-content-between' >
                      <div>
                      <h6 style={{fontWeight: "700", fontSize: "16.07px",fontFamily: "inter"}}>Private Club</h6>
                      </div>
                      {/* <div>
                    ...
                    {
                     privateClub?.slice(0,4).map((club)=>{
                        return (
