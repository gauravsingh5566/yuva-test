...
import { YmBreadCrumbs } from './YmBreadCrumbs'
import { Card, Modal } from 'react-bootstrap';
import { useParliamentContext } from '../context/contextParliament';
...
export const ParliamentEventRegister = () => {
  const { stepCount, setStepCount } = useParliamentContext();
...
const Registration = () => {
  ...
  return (
    ...
    <>
      <YmBreadCrumbs start='Events' middle="Youth Parliament" end="Registration" />
      <div className="px-5">
  ...
  return (
    <>
      ...
      <div className="px-5">
        ...
        <p className='fs-5 fw-500' style={{ color: "#979797" }}>A Teacher Coordinator will help manage, coordinate <br />and organise the event.</p>
        <div className="col-12 col-md-8 col-lg-8">
          <div className="card px-2 dashed-border rounded-4 cursor-pointer mb-4" style={{marginTop:30}}>
...
// <=============Handle Previous Step ============>
  ...
  return (
    <>
      <YmBreadCrumbs start='Events' middle="Youth Parliament" end="Team" />
      <div className="px-5">
        <div className="col-12 col-md-8 col-lg-8 ">
          <div className="mb-2">
...
const ChooseEventTheme = () => {
  ...
  return (
    <>
      <YmBreadCrumbs start='Events' middle="Youth Parliament" end="Theme" />
      <div className="px-5">
        <div className="col-12 col-md-8 col-lg-8 ">
          <div className="mb-2">
