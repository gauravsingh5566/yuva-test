                  ...
                  <div className="row">
                    <div className="col-lg-8">
                      ...
                      <div className="position-relative mb-5">
                        <img src={blogItem.image} alt="post thumb" className="img-fluid w-100" />
                        <div className="card-type hover-ripple">News</div>
                      </div>
                      <div className="card-meta text-uppercase mb-2">
                        by <strong className="text-dark">{blogItem.author}</strong> / on <strong className="text-dark">{blogItem.date}</strong>
                      </div>
                        ...
                        return (
                          <div key={index}>
                            ...
                            {section.paragraph.map((para) => {
                              return (
                                <p key={para} className="text-dark mb-4">
                                  {para}
                                </p>
                              );
                            })}
