          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              (async function submitForm() {
                try {
                  const res = await api.post(`auth/setpassword?id=${collegeId}&key=${secretKey}`, {
                    email: emailId,
              ...
              <Form>
                <div className="row g-3">
                  <div className="col-12">
                    ...
                    <span type="email" value={emailId} disabled={true} className="form-control p-3">
                      {emailId}
                    </span>
                  </div>
                  <div className="col-12">
                  ...
                  <div className="col-12">
                    <span className="text-dark form-label">Confirm Password</span>
                    <Field type="password" name="confirm_password" className="form-control" />
                    <ErrorMessage name="confirm_password" className="text-danger" component="div" />
                  </div>
                  <div className="col-12 text-center">
                    <button type="submit" className="btn btn-primary-outline" disabled={isSubmitting}>
                      Submit
                    </button>
                  </div>
                </div>
