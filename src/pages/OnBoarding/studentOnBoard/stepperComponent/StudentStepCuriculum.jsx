...
export const StudentStepCuriculum = () => {
...
const handleSelectChange = (option) => {
  ...
  const handleNextChild = () => {
    ...
    const initialValues = {
      course: studentFormik.values.curriculum.course ||'',
      program: studentFormik.values.curriculum.program || '',
      stream: studentFormik.values.curriculum.stream || '',
      year: studentFormik.values.curriculum.year || '',
    }
    const onSubmit = () => {
  ...
  return (
   <>
      ...
      <div >
        <div className="mb-2">
          <span className=" fs-2 fw-600">Curriculum</span>
        </div>
        <div >
          <div className="mb-4">
            <span
            ...
            <div className="">
                  <Select
                    styles={customStyles}
                      ...
                      defaultValue={educationLevels.find((i)=>i.name===formik.values.course)}
                      onChange={(e)=>{
                        formik.setFieldValue('course', e.name)
                        setStudenteData('curriculum', {...studentFormik.values.curriculum, course:e.name})
                      }}
                      getOptionLabel={
                        (option)=>{
                          return (
        ...
        <div className="mb-4 col-8">
             ...
             <div className="">
                   ...
                   styles={customStyles}
                       ...
                       defaultValue={selectProgram.find((i)=>i.name===formik.values.program)}
                       onChange={(e)=>{
                        formik.setFieldValue('program',e.name)
                        setStudenteData('curriculum', {...studentFormik.values.curriculum, program:e.name})
                       }}
                       getOptionLabel={
                         (option)=>{
                           return (
  ...
  'Bachelor of Engineering (BE/BTech)',
             ...
             <div className="">
                   ...
                   styles={customStyles}
                       ...
                       defaultValue={selectStream.find((i)=>i.name===formik.values.stream)}
                       onChange={(e)=>{
                        formik.setFieldValue('stream',e.name)
                        setStudenteData('curriculum', {...studentFormik.values.curriculum, stream:e.name})
         ...
         <div className="mb-4 col-8">
             ...
             <div className="">
                   ...
                   styles={customStyles}
                       ...
                       defaultValue={academicYears.find((i)=>i.name===formik.values.year)}
                       onChange={(e)=>{
                        formik.setFieldValue('year',e.name)
                        setStudenteData('curriculum', {...studentFormik.values.curriculum, year:e.name})
                       }}
                       getOptionLabel={
                         (option)=>{
                           return (
...
const educationLevels = [
  ...
  { name: 'Class 7', value: 2 },
  { name: 'Class 8', value: 3 },
  { name: 'Class 9', value: 4 },
  { name: 'Class 10', value: 5 },
  { name: 'Class 11 (Science)', value: 6 },
  { name: 'Class 11 (Commerce)', value: 7 },
  { name: 'Class 11 (Arts)', value: 8 },
  { name: 'Class 12 (Science)', value: 9 },
  { name: 'Class 12 (Commerce)', value: 10 },
  { name: 'Class 12 (Arts)', value: 11 },
